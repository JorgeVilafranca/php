...
<?php
    ...
    function insertarDatos($datos) {
        ...
        // 7 s, porque los datos son todos varchar
        $ok=mysqli_stmt_bind_param($resultados, "sssssss", $datos["c_art"], $datos["seccion"], $datos["n_art"], $datos["precio"], $datos["fecha"], 
            $datos["importado"], $datos["p_orig"]);
        ...
        if (!$ok) {
            ...
            echo "<p>Agregado nuevo registro</p>";
